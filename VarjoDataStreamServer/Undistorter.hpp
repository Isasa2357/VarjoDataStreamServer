...
public:
    //! Constructor
    Undistorter(const glm::ivec2& inputSize, const glm::ivec2& outputSize, const varjo_CameraIntrinsics2& intrinsics, const varjo_Matrix& extrinsics,
...
private:
    ...
    varjo_CameraIntrinsics2 m_intrinsics; //!< Camera intrinsics
};
