 ...
 */
static const varjo_LockType varjo_LockType_VideoPostProcessShader = 1001;  //!< Lock for video pass through post processing shader.
static const varjo_LockType varjo_LockType_VideoDepthTest = 1002;          //!< Lock for video depth test modes and ranges.
